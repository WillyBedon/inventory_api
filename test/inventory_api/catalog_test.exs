defmodule InventoryApi.CatalogTest do
  ...
  describe "products" do
    ...
    @invalid_attrs %{price: nil, reference: nil, sku: nil}
    ...
    test "create_product/1 with valid data creates a product" do
      valid_attrs = %{price: 120.5, reference: "some reference", sku: "some sku"}
    ...
    test "update_product/2 with valid data updates the product" do
      product = product_fixture()
      update_attrs = %{price: 456.7, reference: "some updated reference", sku: "some updated sku"}
